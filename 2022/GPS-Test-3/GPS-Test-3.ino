...
const int tamano=80;
float lat, lon, latMeta=32.379577, lonMeta=115.266670, xv, yv, zv, calibrated_values[3], relativeAltitude, headingDegrees, heading, alpha, theta, beta;
int sat, cuadrantes;
...
void angulo()
{
  ...
  beta=atan((lon-lonMeta)/(lat-latMeta));
  switch(cuadrantes){
    case 1:
      alpha=90;
    case 2:
