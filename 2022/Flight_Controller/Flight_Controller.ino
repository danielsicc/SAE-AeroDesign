...
float xv, yv, zv, relativeAltitude, heading, headingDegrees;
...
void calculatePR()
{
  ...
  int roll = -(atan2(norm.XAxis, sqrt(norm.YAxis*norm.YAxis + norm.ZAxis*norm.ZAxis))*180.0)/M_PI;
  int pitch  = (atan2(norm.YAxis, norm.ZAxis)*180.0)/M_PI;
  // Output
  Serial.print(", Pitch = ");
  Serial.print(pitch);
  Serial.print(", Roll = ");
